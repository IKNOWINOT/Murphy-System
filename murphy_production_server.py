...
async def serve_login():
    html = _resolve_html("login.html")
    return HTMLResponse(html or "<h1>Login</h1><p>Loading login&hellip;</p>")
...
async def serve_grant_wizard():
    ...
    return HTMLResponse(html or "<h1>Grant Wizard</h1><p>Loading grant wizard&hellip;</p>")

@app.get("/ui/terminal-unified", response_class=HTMLResponse)
async def serve_terminal_unified():
    html = _resolve_html("terminal_unified.html")
    return HTMLResponse(html or "<h1>Unified Terminal</h1><p>Loading terminal&hellip;</p>")

@app.get("/ui/docs", response_class=HTMLResponse)
async def serve_docs_page():
    html = _resolve_html("docs.html")
    return HTMLResponse(html or "<h1>Documentation</h1><p>Loading docs&hellip;</p>")

@app.get("/ui/matrix", response_class=HTMLResponse)
async def serve_matrix():
    html = _resolve_html("matrix_integration.html")
    return HTMLResponse(html or "<h1>Matrix Integration</h1><p>Loading Matrix bridge&hellip;</p>")

@app.get("/ui/blog", response_class=HTMLResponse)
async def serve_blog():
    html = _resolve_html("blog.html")
    return HTMLResponse(html or "<h1>Blog</h1><p>Loading blog&hellip;</p>")

@app.get("/ui/careers", response_class=HTMLResponse)
async def serve_careers():
    html = _resolve_html("careers.html")
    return HTMLResponse(html or "<h1>Careers</h1><p>Loading careers&hellip;</p>")

@app.get("/ui/legal", response_class=HTMLResponse)
async def serve_legal():
    html = _resolve_html("legal.html")
    return HTMLResponse(html or "<h1>Legal</h1><p>Loading legal terms&hellip;</p>")

@app.get("/ui/privacy", response_class=HTMLResponse)
async def serve_privacy():
    html = _resolve_html("privacy.html")
    return HTMLResponse(html or "<h1>Privacy Policy</h1><p>Loading privacy policy&hellip;</p>")
