...
ROLE_LENSES = {
    ...
    "vp-sales": {
        ...
        "heuristics": [
            ...
            "PATCH-419: If a prospect raises price as the objection, DO NOT discount blindly. First call /api/treasury/financing-options and /api/grants/programs to see whether matching grants, tax credits, C-PACE, SBA, USDA REAP, BNPL, or utility rebates can reduce the customer's effective monthly carrying cost. Financing changes the payment shape; discounting permanently reduces margin and trains the customer to negotiate. Pivot to financing first; discount only as last resort with founder approval.",
        ],
        "exemplar": (
