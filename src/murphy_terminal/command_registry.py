...
MURPHY_COMMANDS: list[CommandDefinition] = [
    ...
    CommandDefinition("llm_provider_router", "/llm provider", "!murphy llm provider",
        ["llm provider", "set deepinfra", "configure llm"],
        CommandCategory.LLM, "Configure LLM provider (deepinfra/together)", "/llm provider [deepinfra|together]",
        min_role="admin"),
