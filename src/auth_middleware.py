...
class OIDCAuthMiddleware(BaseHTTPMiddleware):
    ...
    * ``MURPHY_AUTH_ENFORCED``       — ``"true"`` to reject unauthenticated
    ...
    EXEMPT_PATHS: Set[str] = {
        ...
        # Ship 31ao.SEE Phase 1b — these endpoints already enforce auth in-handler
        "/api/hitl/items",
        "/api/mail/outbound/stats",
        "/api/mail/outbound/queue",
        "/api/crm/deals",
        "/api/crm/contacts/recent",
        "/api/events/feed",
        "/api/swarm/bus/feed",
        "/api/swarm/scheduler",
        "/api/swarm/hitl/pending",
        "/api/hitl/statistics",
        "/api/hitl-v2/queue",
        "/api/llm/status",
        "/api/prospector/stats",
        "/api/compliance/stats",
        "/api/conductor/workflows",
        "/api/signals/latest",
        "/api/security/tripwire/log",
        "/api/perspective/list",
        "/api/shield/status",
        "/api/soul/entity-map",
        "/api/platform/self-modification/ledger",
        # Ship 31ao.SEE — self-visibility (handlers self-enforce auth)
        "/api/self/audit",
        "/api/self/identity",
        "/api/self/state_of_complete",
        "/api/status",
