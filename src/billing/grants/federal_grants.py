...
SBIR_PHASE1 = Grant(
    ...
    eligible_project_types=["agentic", "ai_platform", "software_rd", "automation_rd", "industrial_iot", "smart_manufacturing", "grid_interactive", "ems", "general_business_automation", "workflow_automation", "compliance_automation"],
...
SBIR_PHASE2 = Grant(
    ...
    eligible_entity_types=["small_business"],
    eligible_project_types=["agentic", "ai_platform", "software_rd", "automation_rd", "industrial_iot", "smart_manufacturing"],
    requires_rd_activity=True,
    is_recurring=True,
    program_expiry_year=2031,
    longevity_note="Reauthorized through Sept 30, 2031",
...
SBIR_STRATEGIC = Grant(
    ...
    eligible_entity_types=["small_business"],
    eligible_project_types=["agentic", "ai_platform", "automation_rd", "universal_automation", "industrial_iot"],
    requires_rd_activity=True,
    is_recurring=True,
...
NSF_CONVERGENCE = Grant(
    ...
    eligible_project_types=["agentic", "ai_platform", "automation_rd", "software_rd"],
    requires_rd_activity=True,
    is_recurring=True,
...
NSF_PFI = Grant(
    ...
    eligible_project_types=["agentic", "ai_platform", "software_rd", "automation_rd"],
    requires_rd_activity=True,
    is_recurring=True,
...
EDA_BUILD_TO_SCALE = Grant(
    ...
    eligible_project_types=["agentic", "general_business_automation", "ai_platform", "automation_rd"],
    is_recurring=True,
...
EDA_TECH_HUBS = Grant(
    ...
    eligible_entity_types=["small_business", "corporation", "university", "nonprofit"],
    eligible_project_types=["agentic", "ai_platform", "automation_rd", "smart_manufacturing", "industrial_iot"],
    is_recurring=True,
