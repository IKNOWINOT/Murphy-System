...
SEC_179D = Grant(
    ...
    stackable_with=["sec_48", "sec_48e", "utility_custom_incentive"],
...
SEC_48_ITC = Grant(
    ...
    stackable_with=["sec_179d", "sec_48c", "sec_45y", "pace_financing", "utility_custom_incentive"],
    ira_bonus=GrantIRABonus(
        prevailing_wage=True,
...
SEC_45Y_PTC = Grant(
    ...
    stackable_with=["sec_48e", "utility_custom_incentive"],
    ira_bonus=GrantIRABonus(
        prevailing_wage=True,
        energy_community=True,
        domestic_content=True,
