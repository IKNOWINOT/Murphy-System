...
// Random projection based semantic proxy (no external SDK).
// rpProject returns a compact string of signed projections (e.g., +/-1) for a fixed seed.
...
export function rpProject(text:string, dims=64){
  ...
  // compress to base64-like string
