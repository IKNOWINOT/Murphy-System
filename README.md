...
- **Competitive alignment info test:** `tests/test_competitive_alignment_info.py` validates `/api/info` integration/alignment summaries and module registry summary parity with runtime builders, including core registry completeness.
