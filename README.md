...
- **Deterministic validation:** supply `compute_request` (expression + language) to `/api/execute` for cached compute plane checks; session/doc tracking attaches once validation succeeds.
