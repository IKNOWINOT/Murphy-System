...
- **Delivery adapter snapshot:** activation previews include document/email/chat/voice adapter readiness; adapters still require configuration and delivery readiness passes through `needs_wiring`/`needs_coverage` when adapters or org chart coverage are incomplete.
