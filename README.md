...
- **Production UI:** serve `Murphy System/murphy_production_ui.html` with `python -m http.server 8090` and open `http://localhost:8090/murphy_production_ui.html?apiPort=6666`
