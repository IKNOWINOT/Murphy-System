...
*This analysis is based on direct inspection of 13,610 files across the Murphy System repository, with deep reading of all primary runtime components in `murphy_system/`.*