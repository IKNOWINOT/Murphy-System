...
# ---------------------------------------------------------------------------
# 6. Mirror check — murphy_system/ subdirectory should be in sync
# ---------------------------------------------------------------------------

class TestMirrorSync:
    """murphy_system/ subdirectory copies should match root files."""
