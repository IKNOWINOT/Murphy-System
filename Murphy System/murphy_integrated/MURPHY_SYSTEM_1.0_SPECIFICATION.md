...
**Location:** `murphy_integrated/src/`
...
**Location:** `murphy_integrated/src/form_intake/`, `confidence_engine/`, etc.
...
**Location:** `murphy_integrated/universal_control_plane.py`
...
**Location:** `murphy_integrated/inoni_business_automation.py`
...
**Location:** `murphy_integrated/src/integration_engine/`
...
**Location:** `murphy_integrated/two_phase_orchestrator.py`
...
### 7. Final Runtime
**Location:** `murphy_integrated/murphy_final_runtime.py`
