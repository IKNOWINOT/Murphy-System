...
- **Module registry standardization:** keep the `module_manager` catalog aligned with `murphy_integrated/src` modules and core runtime (control plane, orchestration, intake, confidence, execution, learning, governance, telemetry, MFGC).
