...
116. Added root `RFI.MD` decision log for unresolved architecture/governance inputs (authority scopes, rulepacks, source-of-truth registry, budgets/T&M, change-order triggers, legacy wiring priority, telemetry precision), and linked it from README for operator visibility.
