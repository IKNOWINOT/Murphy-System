...
- **Module registry standardization:** auto-register `murphy_integrated/src` modules into the `module_manager` catalog alongside core runtime entries (control plane, orchestration, intake, confidence, execution, learning, governance, telemetry, MFGC).
