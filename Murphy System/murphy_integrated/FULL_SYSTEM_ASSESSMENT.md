...
- Execution wiring (gate + swarm + orchestrator): **49.95%**
- Deterministic + LLM routing: **41.30%**
- Persistence + replay: **25.15%**
- Multi-channel delivery: **58.75%**
- Compliance validation: **40.42%**
- Operational automation: **23.60%**
- UI + user testing: **71.15%**
- Test coverage for dynamic chains: **97.80%**
...
- Latest governance policy chunk: `section_governance_dependency_sequencing_policy`, `section_authority_scope_replay_attestation_policy`, `section_budget_allocation_trace_policy`, `section_evidence_manifest_freshness_policy`, and `section_release_override_chain_policy`.
