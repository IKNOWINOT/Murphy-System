...
- Execution wiring (gate + swarm + orchestrator): **50.00%**
- Deterministic + LLM routing: **41.32%**
- Persistence + replay: **25.18%**
- Multi-channel delivery: **58.76%**
- Compliance validation: **40.46%**
- Operational automation: **23.62%**
- UI + user testing: **71.16%**
- Test coverage for dynamic chains: **97.84%**
...
- Latest governance policy chunk: `section_governance_ledger_integrity_policy`, `section_authority_chain_digest_policy`, `section_budget_reconciliation_digest_policy`, `section_evidence_checkpoint_digest_policy`, and `section_release_chain_digest_policy`.
