...
3. **Compliance + delivery tests**: assert approval gating before release of documents/email/chat.
4. **Persistence + replay tests**: verify stored session data, replayed approvals, and rollback.
