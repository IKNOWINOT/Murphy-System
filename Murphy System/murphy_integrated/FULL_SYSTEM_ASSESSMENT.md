...
- Execution wiring (gate + swarm + orchestrator): **49.50%**
- Deterministic + LLM routing: **41.12%**
- Persistence + replay: **24.88%**
- Multi-channel delivery: **58.66%**
- Compliance validation: **40.06%**
- Operational automation: **23.42%**
- UI + user testing: **71.06%**
- Test coverage for dynamic chains: **97.44%**
...
- Latest governance policy chunk: `section_governance_rollup_consistency_policy`, `section_authority_chain_snapshot_policy`, `section_budget_envelope_audit_policy`, `section_evidence_manifest_replay_policy`, and `section_release_override_justification_policy`.
