...
| Test coverage for dynamic chains | 91% | Dynamic plan tests exist; summary surface bundle + consumer parity + consistency + remediation/consistency-gap + completion snapshot + completion remediation + threshold/average/gap-area/total-area/coverage-ratio/backlog/backlog-ratio + execution-profile/enforcement-level/source/control-plane-separation/R&D-candidate/approval-policy checks added; execution/integration tests still pending |
...
- UI + user testing: **70%**
- Test coverage for dynamic chains: **91%**
