// src/clockwork/bots/anomaly_watcher_bot/schema.ts
// Follows the canvas 'Bot standards' prompt (source of truth).
import { z } from 'zod';
...
export const InputSchema = z.object({
  task: z.string().min(1),
  params: z.record(z.any()).optional(),             // e.g., { metric: 'error_rate', window: '15m', threshold: '3sigma' }
