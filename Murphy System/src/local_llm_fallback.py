...
💡 Add a Groq API key (`set key deepinfra gsk_...`) for AI-powered integration planning."""
...
💡 Add a Groq API key (`set key deepinfra gsk_...`) to unlock full AI-powered planning."""
...
• `set key deepinfra <key>` — Add a Groq API key for full AI capabilities
...
Get a free Groq key at https://deepinfra.com/keys for the best experience."""
