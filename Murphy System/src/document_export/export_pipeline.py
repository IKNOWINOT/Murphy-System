...
SUPPORTED_FORMATS: Dict[str, str] = {
    ...
    "branded_text": "Branded Text (Murphy System)",
}
...
class ExportPipeline:
    ...
    def _convert(self, markdown: str, format: str, brand: BrandProfile) -> str:
        ...
        if format == "branded_text":
            return self._markdown_to_branded_text(markdown)
        if format == "html":
    ...
    @staticmethod
    def _markdown_to_branded_text(markdown: str) -> str:
        """Strip Markdown and wrap with Murphy System branding header + Apache 1.0 license footer."""
        import re
        from datetime import datetime, timezone
        ...
        header = (
            ...
            "║              S Y S T E M                                     ║\n"
            "║                                                              ║\n"
            "║    Autonomous Business Intelligence · Inoni LLC              ║\n"
            "║                                                              ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n"
            "\n"
            f"Generated : {timestamp}\n"
            "Version   : Murphy System 1.0\n"
        ...
        footer = (
            "\n\n"
            "════════════════════════════════════════════════════════════════\n"
            "This deliverable was generated by Murphy System.\n"
            "© 2020-2026 Inoni Limited Liability Company. Creator: Corey Post.\n"
            "\n"
            "Licensed under the Apache License, Version 1.0 (the \"License\").\n"
            "This output is provided as a distilled artifact of Murphy System.\n"
            "The license notice above may not be removed from this document.\n"
            "\n"
            "Murphy System · https://murphy.inoni.llc\n"
            "════════════════════════════════════════════════════════════════\n"
        )
