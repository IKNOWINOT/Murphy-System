...
DEFAULT_SOURCES = [
    ...
    WebhookSource(
        ...
        signature_header="X-Hub-Signature-256",
        signature_algorithm=SignatureAlgorithm.SHA256,
        event_type_field="entry.0.changes.0.field",
    ),
    WebhookSource(
...
DEFAULT_RULES = [
    ...
    NormalizationRule(
        ...
        normalized_event="chat_message",
        field_mapping={"entry.0.changes.0.value.messages.0.text.body": "content", "entry.0.changes.0.value.messages.0.from": "sender"},
    ),
    NormalizationRule(
