...
from .runtime_deployment_modes_v6 import RuntimeDeploymentModesV6
from .runtime_lineage_v6 import RuntimeLineageV6


class OperatorRuntimeSurfaceV7:
    """Unified runtime/operator surface aligned to canonical execution v4 defaults."""

    def __init__(
        self,
        operator_status: ConfigurableOperatorStatusService,
        lineage: RuntimeLineageV6 | None = None,
        deployment_modes: RuntimeDeploymentModesV6 | None = None,
    ) -> None:
        self.operator_status = operator_status
        self.lineage = lineage or RuntimeLineageV6()
        self.deployment_modes = deployment_modes or RuntimeDeploymentModesV6()
