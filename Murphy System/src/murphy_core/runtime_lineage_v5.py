...
class RuntimeLineageV5:
    """Runtime lineage with canonical execution v3 as the preferred default path."""
    ...
    def __init__(self) -> None:
        self.layers: List[RuntimeLayer] = [
            ...
            RuntimeLayer("murphy_core_v3_canonical_execution_surface", "src/murphy_core/app_v3_canonical_execution_surface.py", "src/runtime/murphy_core_bridge_v3_canonical_execution_surface.py", "src/runtime/main_core_v3_canonical_execution_surface.py", "rollback", "compatibility", ["Canonical execution correction step superseded by v2/v3 alignment"]),
            RuntimeLayer("murphy_core_v3_canonical_execution_surface_v2", "src/murphy_core/app_v3_canonical_execution_surface_v2.py", "src/runtime/murphy_core_bridge_v3_canonical_execution_surface_v2.py", "src/runtime/main_core_v3_canonical_execution_surface_v2.py", "rollback", "compatibility", ["Canonical execution v2 superseded by v3 truth alignment"]),
            RuntimeLayer("murphy_core_v3_canonical_execution_surface_v3", "src/murphy_core/app_v3_canonical_execution_surface_v3.py", "src/runtime/murphy_core_bridge_v3_canonical_execution_surface_v3.py", "src/runtime/main_core_v3_canonical_execution_surface_v3.py", "preferred", "canonical", ["Current preferred default runtime for users and automations with founder overlay available"]),
        ]
