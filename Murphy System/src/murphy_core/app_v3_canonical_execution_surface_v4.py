...
from .operator_runtime_surface_v6 import OperatorRuntimeSurfaceV6
...
class CoreV3CanonicalExecutionSurfaceV4Services:
    def __init__(self, config: CoreConfig | None = None) -> None:
        ...
        self.runtime_surface = OperatorRuntimeSurfaceV6(self.operator_status)
...
def create_app() -> FastAPI:
    services = CoreV3CanonicalExecutionSurfaceV4Services()
    app = FastAPI(
        title=services.config.app_name,
        description="Murphy System canonical execution surface v4 with founder visibility overlay and runtime truth v6",
    ...
    async def health() -> JSONResponse:
        return JSONResponse({
            "status": "healthy",
            "service": "murphy_core_v3_canonical_execution_surface_v4",
