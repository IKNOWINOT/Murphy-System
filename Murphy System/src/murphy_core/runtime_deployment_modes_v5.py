...
class RuntimeDeploymentModesV5:
    """Deployment choices with canonical execution v3 as the default mode."""

    def __init__(self) -> None:
        self.modes: List[DeploymentMode] = [
            DeploymentMode(
                name="canonical_execution_surface_v3",
                app_target="src/murphy_core/app_v3_canonical_execution_surface_v3.py",
                startup="src/runtime/main_core_v3_canonical_execution_surface_v3.py",
                category="canonical",
                preferred_for=[
    ...
    def preferred_direct(self) -> DeploymentMode:
        return next(mode for mode in self.modes if mode.name == "canonical_execution_surface_v3")
