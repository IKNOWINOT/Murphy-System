...
from .runtime_deployment_modes_v4 import RuntimeDeploymentModesV4
from .runtime_lineage_v4 import RuntimeLineageV4


class OperatorRuntimeSurfaceV5:
    """Unified runtime/operator surface aligned to canonical execution v2 defaults."""

    def __init__(
        self,
        operator_status: ConfigurableOperatorStatusService,
        lineage: RuntimeLineageV4 | None = None,
        deployment_modes: RuntimeDeploymentModesV4 | None = None,
    ) -> None:
        self.operator_status = operator_status
        self.lineage = lineage or RuntimeLineageV4()
        self.deployment_modes = deployment_modes or RuntimeDeploymentModesV4()
