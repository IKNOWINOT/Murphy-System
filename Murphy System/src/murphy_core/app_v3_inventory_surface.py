...
class CoreV3InventorySurfaceServices:
...
def create_app() -> FastAPI:
    services = CoreV3InventorySurfaceServices()
    app = FastAPI(
        title=services.config.app_name,
        description="Murphy System runtime-correct core with runtime and inventory surfaces",
    ...
    async def health() -> JSONResponse:
        return JSONResponse({
            "status": "healthy",
            "service": "murphy_core_v3_inventory_surface",
