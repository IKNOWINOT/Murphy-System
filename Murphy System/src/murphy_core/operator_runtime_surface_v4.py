...
from .runtime_deployment_modes_v3 import RuntimeDeploymentModesV3
from .runtime_lineage_v3 import RuntimeLineageV3


class OperatorRuntimeSurfaceV4:
    """Unified runtime/operator surface aligned to canonical execution defaults."""

    def __init__(
        self,
        operator_status: ConfigurableOperatorStatusService,
        lineage: RuntimeLineageV3 | None = None,
        deployment_modes: RuntimeDeploymentModesV3 | None = None,
    ) -> None:
        self.operator_status = operator_status
        self.lineage = lineage or RuntimeLineageV3()
        self.deployment_modes = deployment_modes or RuntimeDeploymentModesV3()
