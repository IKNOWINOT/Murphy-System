...
class RuntimeDeploymentModesV4:
    """Deployment choices with canonical execution v2 as the default mode."""

    def __init__(self) -> None:
        self.modes: List[DeploymentMode] = [
            DeploymentMode(
                name="canonical_execution_surface_v2",
                app_target="src/murphy_core/app_v3_canonical_execution_surface_v2.py",
    ...
    def preferred_direct(self) -> DeploymentMode:
        return next(mode for mode in self.modes if mode.name == "canonical_execution_surface_v2")
