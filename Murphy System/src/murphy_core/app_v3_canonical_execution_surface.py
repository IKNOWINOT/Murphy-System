...
class CoreV3CanonicalExecutionSurfaceServices:
...
def create_app() -> FastAPI:
    services = CoreV3CanonicalExecutionSurfaceServices()
    app = FastAPI(
        title=services.config.app_name,
        description="Murphy System canonical execution surface with privileged founder visibility overlay",
    ...
    async def health() -> JSONResponse:
        return JSONResponse(
            {
                "status": "healthy",
                "service": "murphy_core_v3_canonical_execution_surface",
