...
from .runtime_deployment_modes_v2 import RuntimeDeploymentModesV2
from .runtime_lineage_v2 import RuntimeLineageV2


class OperatorRuntimeSurfaceV3:
    """Unified runtime/operator surface aligned to the founder execution path."""

    def __init__(
        self,
        operator_status: ConfigurableOperatorStatusService,
        lineage: RuntimeLineageV2 | None = None,
        deployment_modes: RuntimeDeploymentModesV2 | None = None,
    ) -> None:
        self.operator_status = operator_status
        self.lineage = lineage or RuntimeLineageV2()
        self.deployment_modes = deployment_modes or RuntimeDeploymentModesV2()
