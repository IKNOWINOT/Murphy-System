...
class RuntimeDeploymentModesV3:
    """Deployment choices with canonical execution as the default mode."""

    def __init__(self) -> None:
        self.modes: List[DeploymentMode] = [
            DeploymentMode(
                name="canonical_execution_surface",
                app_target="src/murphy_core/app_v3_canonical_execution_surface.py",
    ...
    def preferred_direct(self) -> DeploymentMode:
        return next(mode for mode in self.modes if mode.name == "canonical_execution_surface")
