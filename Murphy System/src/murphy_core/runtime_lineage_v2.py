...
class RuntimeLineageV2:
    """Runtime lineage with founder execution surface as preferred production path."""
    ...
    def __init__(self) -> None:
        self.layers: List[RuntimeLayer] = [
            ...
            RuntimeLayer(
                ...
                status="rollback",
                role="compatibility",
                notes=["Runtime-correct path retained as fallback"],
            ),
            RuntimeLayer(
            ...
            RuntimeLayer(
                name="murphy_core_v3_founder_execution_surface",
                app_factory="src/murphy_core/app_v3_founder_execution_surface.py",
                bridge="src/runtime/murphy_core_bridge_v3_founder_execution_surface.py",
                startup="src/runtime/main_core_v3_founder_execution_surface.py",
                status="preferred",
                role="canonical",
                notes=["Current preferred production path with unified founder/admin visibility and capability-aware execution"],
            ),
        ]
