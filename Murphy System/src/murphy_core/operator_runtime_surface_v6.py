...
from .runtime_deployment_modes_v5 import RuntimeDeploymentModesV5
from .runtime_lineage_v5 import RuntimeLineageV5


class OperatorRuntimeSurfaceV6:
    """Unified runtime/operator surface aligned to canonical execution v3 defaults."""

    def __init__(
        self,
        operator_status: ConfigurableOperatorStatusService,
        lineage: RuntimeLineageV5 | None = None,
        deployment_modes: RuntimeDeploymentModesV5 | None = None,
    ) -> None:
        self.operator_status = operator_status
        self.lineage = lineage or RuntimeLineageV5()
        self.deployment_modes = deployment_modes or RuntimeDeploymentModesV5()
