...
class CoreV3CanonicalExecutionSurfaceV5Services:
...
def create_app() -> FastAPI:
    services = CoreV3CanonicalExecutionSurfaceV5Services()
    app = FastAPI(
        title=services.config.app_name,
        description="Murphy System canonical execution surface v5 with founder visibility overlay and runtime truth v7",
    ...
    async def health() -> JSONResponse:
        return JSONResponse({
            "status": "healthy",
            "service": "murphy_core_v3_canonical_execution_surface_v5",
