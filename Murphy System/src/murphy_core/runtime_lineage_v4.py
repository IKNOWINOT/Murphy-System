...
class RuntimeLineageV4:
    """Runtime lineage with canonical execution v2 as the preferred default path."""
    ...
    def __init__(self) -> None:
        self.layers: List[RuntimeLayer] = [
            ...
            RuntimeLayer(
                ...
                status="rollback",
                role="compatibility",
                notes=["Canonical execution correction step superseded by v2 alignment"],
            ),
            RuntimeLayer(
                name="murphy_core_v3_canonical_execution_surface_v2",
                app_factory="src/murphy_core/app_v3_canonical_execution_surface_v2.py",
                bridge="src/runtime/murphy_core_bridge_v3_canonical_execution_surface_v2.py",
                startup="src/runtime/main_core_v3_canonical_execution_surface_v2.py",
                status="preferred",
                role="canonical",
