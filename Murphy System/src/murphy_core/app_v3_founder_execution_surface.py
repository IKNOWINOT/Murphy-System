...
class CoreV3FounderExecutionSurfaceServices:
...
def create_app() -> FastAPI:
    services = CoreV3FounderExecutionSurfaceServices()
    app = FastAPI(
        title=services.config.app_name,
        description="Murphy System founder execution surface with unified visibility and capability-aware gating",
    ...
    async def health() -> JSONResponse:
        return JSONResponse(
            {
                "status": "healthy",
                "service": "murphy_core_v3_founder_execution_surface",
