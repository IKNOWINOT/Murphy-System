...
class RuntimeLineageV6:
    """Runtime lineage with canonical execution v4 as the preferred default path."""
    ...
    def __init__(self) -> None:
        self.layers: List[RuntimeLayer] = [
            ...
            RuntimeLayer("murphy_core_v3_canonical_execution_surface_v3", "src/murphy_core/app_v3_canonical_execution_surface_v3.py", "src/runtime/murphy_core_bridge_v3_canonical_execution_surface_v3.py", "src/runtime/main_core_v3_canonical_execution_surface_v3.py", "rollback", "compatibility", ["Canonical execution v3 superseded by v4 default"]),
