...
class RuntimeDeploymentModesV6:
    """Deployment choices with canonical execution v4 as the default mode."""

    def __init__(self) -> None:
        self.modes: List[DeploymentMode] = [
            DeploymentMode(
                name="canonical_execution_surface_v4",
                app_target="src/murphy_core/app_v3_canonical_execution_surface_v4.py",
                startup="src/runtime/main_core_v3_canonical_execution_surface_v4.py",
                category="canonical",
                preferred_for=[
    ...
    def preferred_direct(self) -> DeploymentMode:
        return next(mode for mode in self.modes if mode.name == "canonical_execution_surface_v4")
