...
Design Label: SSE-001 — Autonomous Self-Selling Pipeline
Owner: Sales / Platform Engineering
License: BSL 1.1

Murphy sells Murphy. No human at Inoni sells the product. The system
contacts prospects and **the fact that it's contacting them IS the demo**.

Architecture: 5-Phase Autonomous Sales Loop
  Phase 1: Prospect Discovery & Constraint Generation (ProspectOnboarder)
  Phase 2: Self-Selling Outreach (SelfSellingOutreach)
  Phase 3: Trial Orchestrator (TrialOrchestrator) — see trial_orchestrator.py
  Phase 4: Shadow Agent Handoff (TrialShadowDeployer)
  Phase 5: HITL Contractor Bridge for External Data (ContractorAugmentedIntel)
