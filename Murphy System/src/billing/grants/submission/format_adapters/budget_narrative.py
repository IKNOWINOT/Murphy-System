...
class BudgetNarrativeBuilder:
    ...
    def build(self, application_data: Dict) -> str:
        ...
        lines = [
            ...
            f"",
            f"C. TRAVEL",
            f"Travel costs are included for project-related site visits and conference participation.",
            f"",
            f"D. SUPPLIES",
            f"Supplies necessary for project activities are included in direct costs.",
            f"",
            f"E. OTHER DIRECT COSTS",
