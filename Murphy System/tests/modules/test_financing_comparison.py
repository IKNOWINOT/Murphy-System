...
class TestFinancingMirrorFiles:
    """Murphy System/ mirror files exist and match root files."""

    def test_mirror_financing_exists(self):
        mirror = os.path.join(REPO_ROOT, "Murphy System", "financing_options.html")
        assert os.path.isfile(mirror), "Murphy System/financing_options.html mirror must exist"

    def test_mirror_grant_wizard_exists(self):
        mirror = os.path.join(REPO_ROOT, "Murphy System", "grant_wizard.html")
        assert os.path.isfile(mirror), "Murphy System/grant_wizard.html mirror must exist"

    def test_mirror_grant_dashboard_exists(self):
        mirror = os.path.join(REPO_ROOT, "Murphy System", "grant_dashboard.html")
        assert os.path.isfile(mirror), "Murphy System/grant_dashboard.html mirror must exist"

    def test_mirror_grant_application_exists(self):
        mirror = os.path.join(REPO_ROOT, "Murphy System", "grant_application.html")
        assert os.path.isfile(mirror), "Murphy System/grant_application.html mirror must exist"
