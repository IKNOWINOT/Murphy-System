...
from src.murphy_core.runtime_access_modes import RuntimeAccessModes
...
def test_runtime_access_modes_separate_canonical_and_founder_overlay():
    access = RuntimeAccessModes().to_dict()
    assert access['canonical']['name'] == 'canonical_execution'
    assert access['founder_overlay']['name'] == 'founder_visibility_overlay'
