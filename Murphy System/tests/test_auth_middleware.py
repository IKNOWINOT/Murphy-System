...
try:
    import src.auth_middleware
    _MODULE_AVAILABLE = True
except ImportError:
    _MODULE_AVAILABLE = False


@pytest.mark.skipif(not _MODULE_AVAILABLE, reason="auth_middleware not importable")
class TestAuthMiddlewareSmoke:
    ...
    def test_module_has_docstring(self):
        ...
        import src.auth_middleware as mod
