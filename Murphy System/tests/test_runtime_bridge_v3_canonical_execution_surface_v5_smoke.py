...
def test_bridge_canonical_execution_surface_v5_prefers_canonical_v5_app():
    app = create_bridge_app(prefer_canonical_execution_surface_v5=True)
...
def test_bridge_canonical_execution_surface_v5_founder_overlay_available():
    app = create_bridge_app(prefer_canonical_execution_surface_v5=True)
    client = TestClient(app)
