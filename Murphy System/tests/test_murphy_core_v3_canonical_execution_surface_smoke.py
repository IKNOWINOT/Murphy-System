...
def test_canonical_execution_surface_health_identity():
...
def test_canonical_execution_surface_execute_includes_family_selection():
...
def test_canonical_execution_surface_readiness_flags_founder_overlay():
