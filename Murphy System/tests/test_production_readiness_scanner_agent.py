...
class TestScanModuleInventory:
    ...
    def test_inventory_finds_packages_and_modules(self, tmp_src):
...
class TestScanDebtMarkers:
    ...
    def test_detects_todo_markers(self, tmp_src):
...
class TestScanDocstringCoverage:
    ...
    def test_detects_missing_docstrings(self, tmp_src):
    ...
    def test_empty_dir(self, tmp_path):
        ...
        result = scan_docstring_coverage(tmp_path / "nonexistent")
