@echo off
REM Murphy System - Windows Installation Script (FIXED)
...
python -c "import aiohttp; print('[OK] aiohttp installed:', aiohttp.__version__)" || echo [ERROR] aiohttp NOT installed!
python -c "import nest_asyncio; print('[OK] nest_asyncio installed')" || echo [ERROR] nest_asyncio NOT installed!
python -c "import groq; print('[OK] groq installed')" || echo [ERROR] groq NOT installed!
