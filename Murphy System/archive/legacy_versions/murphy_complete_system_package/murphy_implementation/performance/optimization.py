...
class PerformanceOptimizationSystem:
    ...
    def __init__(self):
        ...
        self.monitor.set_threshold("uncertainty_calculation_ms", 1000)
        self.monitor.set_threshold("risk_lookup_ms", 500)
        self.monitor.set_threshold("validation_ms", 2000)
    ...
    def record_performance(self, name: str, value: float, unit: str = "ms"):
        ...
        self.monitor.record_metric(name, value, unit)
