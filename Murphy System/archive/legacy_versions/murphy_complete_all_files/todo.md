...
**Problem:** User has Python 3.13 which has multiple compatibility issues:
1. `aiohttp` - requires Visual C++ compiler
2. `pydantic` - ModuleNotFoundError: No module named 'pydantic_core._pydantic_core'

**Root Cause:** Python 3.13 is too new (released Oct 2024). Many packages don't have pre-built wheels yet.

**ONLY SOLUTION:** Downgrade to Python 3.12 (stable, all packages work)
