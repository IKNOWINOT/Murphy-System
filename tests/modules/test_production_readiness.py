...
class TestDocumentationCompleteness:
    ...
    DOC_BASE = Path(__file__).resolve().parent.parent.parent / "documentation"
...
class TestProductionReadinessAudit:
    ...
    AUDIT_DOC = Path(__file__).resolve().parent.parent.parent / "strategic" / "PRODUCTION_READINESS_AUDIT.md"
