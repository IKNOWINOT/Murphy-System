...
# After repo flattening, the repository root is the same as the project root.
...
class TestReadmeModuleCounts:
    ...
    def _murphy_readme(self) -> str:
        # After repo flattening, there is only one README.md at the project root.
        with open(os.path.join(_PROJECT_ROOT, "README.md")) as fh:
            return fh.read()

    def _root_readme(self) -> str:
        # After repo flattening, the project root IS the repository root.
        with open(os.path.join(_PROJECT_ROOT, "README.md")) as fh:
            return fh.read()
