...
|--------|------|-------------|--------|-----------------|
| `murphy_system_1.0_runtime.py` | repository root | Thin entry-point; re-exports all public symbols — implementation lives in `src/runtime/` (INC-13 closed) | ✅ | fastapi, uvicorn, pydantic |
