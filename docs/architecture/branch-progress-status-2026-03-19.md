...
- broader production validation for fallback behavior, endpoint flags, ops/dashboard summaries, founder visibility summaries, founder snapshot visibility, and recovery traces against live MurphySystem integrations
