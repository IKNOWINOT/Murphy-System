# Boot Path Decision v4

## Default production path

Use the canonical execution v4 path when you want the strongest current Murphy backend for users and automations.
...
- canonical execution v4 is temporarily not the desired boot path
