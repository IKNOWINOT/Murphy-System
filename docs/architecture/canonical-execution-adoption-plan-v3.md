# Canonical Execution Adoption Plan v3

## Purpose

This document updates the preferred production target after canonical execution v4 became the strongest bootable default stack.
...
### Direct app factory
```bash
uvicorn src.murphy_core.app_v3_canonical_execution_surface_v4:create_app --factory
```

## Remaining non-default paths

### Canonical execution v1/v2/v3
Useful correction steps, but superseded by the current v4 default stack.
